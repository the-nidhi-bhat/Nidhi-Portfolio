      ...
      <div className="relative z-20 mt-4 sm:mt-2 md:-mt-1">
        <div className="overflow-hidden">
          <motion.h1
            ...
            className="font-display hero-heading w-full whitespace-nowrap font-bold leading-[0.95] tracking-tight text-[12.6vw] sm:text-[10.8vw] md:text-[14.5vw] lg:text-[14.5vw]"
          >
            HI, I&apos;M NIDHI
          </motion.h1>
        </div>
